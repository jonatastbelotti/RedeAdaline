...
public class Main extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    jTxtPeso4 = new javax.swing.JTextField();
    ...
    jTxtPeso4.setText("0,00000");
    jTxtPeso4.setEnabled(false);
        ...
        .addGroup(jPnTreinamentoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
          ...
          .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPnTreinamentoLayout.createSequentialGroup()
            ...
            .addGroup(jPnTreinamentoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
              ...
              .addComponent(jTxtPeso4, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
  ...
  private javax.swing.JTextField jTxtPeso4;
  ...
  private void acaoBotaoClassificar() {
    ...
    for (String linha : jTxtExecucao.getText().replaceAll("\r", "").split("\n")) {
      ...
      valor4 = Double.parseDouble(vetor[i].replace(",", "."));

      resposta += linha + " - " + redeAdaline.classificar(valor1, valor2, valor3, valor4) + "\n";
    }
  ...
  private boolean validarPesosIniciais() {
    try {
      ...
      if (Double.parseDouble(jTxtPeso4.getText().replace(",", ".")) < 0.0 || Double.parseDouble(jTxtPeso4.getText().replace(",", ".")) > 1.0) {
        return false;
      }
    } catch (Exception e) {
      return false;
  ...
  private boolean validarDados() {
    ...
    for (String linha : jTxtExecucao.getText().replaceAll("\r", "").split("\n")) {
      ...
      if ((vetor.length - i) != Adaline.NUM_SINAIS_ENTRADA) {
        return false;
      }
  ...
  private void treinarRede() {
    ...
    if (jChPesosAleatorios.isSelected()) {
      this.redeAdaline = new Adaline();

      jTxtPeso0.setText(Double.toString(redeAdaline.getPeso0()).replace(".", ","));
      jTxtPeso1.setText(Double.toString(redeAdaline.getPeso1()).replace(".", ","));
      jTxtPeso2.setText(Double.toString(redeAdaline.getPeso2()).replace(".", ","));
      jTxtPeso3.setText(Double.toString(redeAdaline.getPeso3()).replace(".", ","));
      jTxtPeso4.setText(Double.toString(redeAdaline.getPeso4()).replace(".", ","));

      jTxtPeso0.setCaretPosition(0);
      jTxtPeso1.setCaretPosition(0);
      jTxtPeso2.setCaretPosition(0);
      jTxtPeso3.setCaretPosition(0);
      jTxtPeso4.setCaretPosition(0);
    }
    ...
    if (jChPesosFixos.isSelected()) {
      ...
      p4 = Double.parseDouble(jTxtPeso4.getText().replace(",", "."));
      
      this.redeAdaline = new Adaline(p0, p1, p2, p3, p4);
    }


    if (this.redeAdaline.treinarRede(arquivoTreinamento) == false) {
      JOptionPane.showMessageDialog(null, "Ocorreu um erro ao treinar a rede Adaline, por favor tente novamente.\nCaso o erro persista entre em contato com o desenvolvedor.", "Erro ao treinar rede", JOptionPane.ERROR_MESSAGE);
      return;
    }

    jBtnClassificar.setEnabled(true);
    JOptionPane.showMessageDialog(null, "Rede Adaline treinada com sucesso.\nÉpocas: " + redeAdaline.getNumEpocasTreinamento(), "Sucesso", JOptionPane.INFORMATION_MESSAGE);
  }
}
